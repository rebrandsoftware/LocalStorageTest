...
var LocalStore = function(successCallback, errorCallback) {
   ...
   this.saveCloudQueue = function (cloudData, cloudDataId, cloudIdRemote, cloudBlob, callback) {
        ...
        //console.log("saveCloudQueue user: " + mUsername);
        ...
        var cloudIsBlob = 0;
        //function Cloud(cloudId, user, appId, cloudIdRemote, cloudIdLocal, cloudData, username, password, encoding, cloudDataId, cloudHasBlob) {
        var c = new Cloud(id, mUsername, appId, cloudIdRemote, id, cloudData, "", "", false, cloudDataId, cloudHasBlob, cloudIsBlob, 1, 1);
        //console.log("Queueing:");
        //console.log("Adding cloud" + id);
    ...
    this.saveCloudQueueBlob = function (cloudData, cloudIdRemote, cloudPieceId, cloudIdLocal, maxParts, callback) {
        ...
        var c = new Cloud(id, mUsername, appId, cloudIdRemote, cloudIdLocal, cloudData, "", "", false, "", cloudHasBlob, cloudIsBlob, cloudPieceId, maxParts);
    ...
    this.saveCloudBlob = function (blobLocalId, blobData, callback) {
        ...
        if (blobData !== undefined) {
            ...
            var c = new CloudBlob(id, blobData, mUsername, blobLocalId);
            //console.log(c);
    ...
    this.findNextCloud = function (username, cloudUsername, cloudType, callback) {
        ...
        switch (cloudType) {
            case "push":
                ...
                for (i = 0; i < l; i++) {
                    myHist = app.findCloudHistNoCallback(clouds[i].cloudId, username, cloudUsername, "push");
                    //console.log(myHist);
                   if (myHist === null) {
                            cloudRet = clouds[i];
    ...
    this.deleteCloudBlobById = function (cloudBlobId, callback) {
        ...
        if (cloudBlobId !== undefined) {
            ...
            lsRemove("cloudBlob" + cloudBlobId, "CloudBlob");
        }
        callback();
    };
    ...
    this.addOldGameData = function(callback) {
        var games = [
                ...
                {"game_bggid": "13", "game_id": "TheSettlersofCatan", "game_name": "The Settlers of Catan", "game_icon": "img/games/BoxTheSettlersOfCatan.jpg"},
                ...
                {"game_bggid": "2921", "game_id": "TheGameofLife", "game_name": "Game of Life, The", "game_icon": "img/games/BoxTheGameOfLife.jpg"},
                {"game_bggid": "41114", "game_id": "TheResistance", "game_name": "Resistance, The", "game_icon": "img/games/BoxTheResistance.jpg"},
        ...
        var scoreitems = [
                ...
                {"item_id": 11, "game_id": "TheSettlersofCatan", "sort": 0, "scoreitem": "Name=Points|Type=Counter|Value=1|Default=0"},
                ...
                {"item_id": 86, "game_id": "Eclipse", "sort": 5, "scoreitem": "Name=Military Technology Track Progress|Type=Combo|Values=<4 Tiles^0,4 Tiles^1,5 Tiles^2,6 Tiles^3,7 Tiles^5|"},
                {"item_id": 193, "game_id": "Eclipse", "sort": 6, "scoreitem": "Name=Grid Technology Track Progress|Type=Combo|Values=<4 Tiles^0,4 Tiles^1,5 Tiles^2,6 Tiles^3,7 Tiles^5|"},
                {"item_id": 194, "game_id": "Eclipse", "sort": 7, "scoreitem": "Name=Nano Technology Track Progress|Type=Combo|Values=<4 Tiles^0,4 Tiles^1,5 Tiles^2,6 Tiles^3,7 Tiles^5|"},                                    
                {"item_id": 195, "game_id": "Eclipse", "sort": 8, "scoreitem": "Name=Has Traitor Card|Type=Combo|Values=No^0,Yes^-2|"},
                {"item_id": 196, "game_id": "Eclipse", "sort": 9, "scoreitem": "Name=Species Bonuses|Type=Counter|Value=1|Default=0|"},
                ...
                {"item_id": 131, "game_id": "TheGameofLife", "sort": 0, "scoreitem": "Name=Win/Lose|Type=Toggle"},
                //{"item_id": 1, "game_id": 46, "game_name": "The Resistance", "game_icon": "img/games/BoxPowerGrid.jpg"},
                {"item_id": 132, "game_id": "TheResistance", "sort": 0, "scoreitem": "Name=Win/Lose|Type=Toggle"},
